from backend.examples.auth_requests import (
    user_login_curl,
    user_logout_curl,
...
from backend.examples.auth_responses import (
...
from backend.examples.user_requests import profile_update_curl
from backend.examples.user_responses import (
