...
from backend.urls.auth_urls import rest_auth_urls
from backend.urls.swagger_urls import swagger_urlpatterns
from backend.urls.versioned_urls import versioned_urls
